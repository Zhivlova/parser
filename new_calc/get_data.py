...
def oil_export(input_data):
    ...
    result_to_front[
        'prices_on_world_market_of_group_b_products'] = prices_on_world_market_of_group_b_products.to_dict(
        'index')
    result_to_front[
        'calculation_of_amount_of_export_customs_duty'] = calculation_of_amount_of_export_customs_duty.to_dict(
        'index')
    ...
    result_to_front['internal_production_and_balance_of_goods_a'] = internal_production_and_balance_of_goods_a.to_dict(
        'index')
    result_to_front['internal_production_of_goods_c'] = internal_production_of_goods_c.to_dict('index')
    result_to_front['production_and_balance_of_group_b_goods'] = production_and_balance_of_group_b_goods.to_dict('index')
