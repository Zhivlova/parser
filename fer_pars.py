...
mydir = '/Users/natalazivlova/Desktop/parser/'
myfile = 'PE_удобрения_20230110 (1).xlsm'
...
for row in range(2, 15):
    name = sheet[row][8].value
    parameters['name'].append(name)
    before = sheet[row][9].value
    parameters['before'].append(before)
    after = sheet[row][10].value
