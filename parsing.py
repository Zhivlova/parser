...
myData = [["title", "description", "answer", "links"],
          [title, description, answer_options, all_download_links]]
...
r = requests.get('https://wciom.ru/ratings/dejatelnost-gosudarstvennykh-institutov')
print(r)